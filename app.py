...
lottie_qual = load_lottieurl("https://assets2.lottiefiles.com/private_files/lf30_rkjmin40.json")
...
with col1:
    st.image(dp_file, width=300)
with col2:
    
    st.title("Hi :wave:,")
    st.title(name)
    st.title("I am a Roboticist and a Data Analyst")
...
with st.container():
    ...
    with left_col:
        ...
        st.write("This was made my using streamlit and Python and deployed through Render.")
    with right_col:
...
with st.container():
    left_col, right_col = st.columns(2)
    with left_col:
        st.header("Qualifications and Certifications")
        st.markdown("---")
    ...
    with right_col:
        ...
        st.subheader("Master's in Mechatronics and Intelligent Machines")
        st.write("University of Central Lancashire, preston")
        st.write("Graduated with Distinction") 
        st.write("JAN 2021 - JULY 2022")
        st.markdown("***")
        st.subheader("Bachelor's in Mechatronics Engineering")
        ...
        st.markdown("***")
        st.subheader("Deep Learning A-Z Hands-on Artificial Neural Network Completion Certificate from Udemy")
...
with st.container():
    ...
    with img_column:
        # Add your image here.
        st.image(project_img1,width=450)
    ...
    with img_column:
        # Add your image here.
        st.image(project2_img,width=450)
    ...
    with img_column:
        # Add your image here.
        st.image(project3_img, width=450)

        with text_column:
            st.subheader("WareHouse Management System Using 4DOF Robotic Arm")
    ...
    with img_column:
        # Add your image here.
        st.image(project4_img, width=450)
        ...
        with text_column:
            ...
            st.write("It was really fun to play around with this quadroped robot :smile:.")
